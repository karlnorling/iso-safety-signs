...
const _title = "Door opens by pushing on the left-hand side";
const _description = "Door opens by pushing on the left-hand side";

export const E022DoorOpensByPushingOnTheLeftHandSide = defineComponent({
  name: 'E022DoorOpensByPushingOnTheLeftHandSide',
  inheritAttrs: false,
  props: signProps,
  setup(props, { attrs }) {
