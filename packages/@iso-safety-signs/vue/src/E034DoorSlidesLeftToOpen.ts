...
const _title = "Door slides left to open";
const _description = "Door slides left to open";

export const E034DoorSlidesLeftToOpen = defineComponent({
  name: 'E034DoorSlidesLeftToOpen',
  inheritAttrs: false,
  props: signProps,
  setup(props, { attrs }) {
