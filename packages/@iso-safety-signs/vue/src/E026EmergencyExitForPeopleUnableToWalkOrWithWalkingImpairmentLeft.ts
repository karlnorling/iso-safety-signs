...
export const E026EmergencyExitForPeopleUnableToWalkOrWithWalkingImpairmentLeft = defineComponent({
  name: 'E026EmergencyExitForPeopleUnableToWalkOrWithWalkingImpairmentLeft',
  inheritAttrs: false,
  props: signProps,
  setup(props, { attrs }) {
