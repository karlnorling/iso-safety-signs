...
const _title = "Evacuation assembly point";
const _description = "Evacuation assembly point";

export const E007EvacuationAssemblyPoint = defineComponent({
  name: 'E007EvacuationAssemblyPoint',
  inheritAttrs: false,
  props: signProps,
  setup(props, { attrs }) {
