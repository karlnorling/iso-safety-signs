...
export const M025ProtectInfantsEyesWithOpaqueEyeProtection = defineComponent({
  ...
  setup(props, { attrs }) {
    return () => {
      const descId = `iso-desc-m025-protect-infants-eyes-with-opaque-eye-protection`;
      const titleId = `iso-title-m025-protect-infants-eyes-with-opaque-eye-protection`;
