...
export const M006DisconnectMainsPlugFromElectricalOutlet = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-m006-disconnect-mains-plug-from-electrical-outlet`;
  const titleId = `iso-title-m006-disconnect-mains-plug-from-electrical-outlet`;
...
M006DisconnectMainsPlugFromElectricalOutlet.displayName = 'M006DisconnectMainsPlugFromElectricalOutlet';
