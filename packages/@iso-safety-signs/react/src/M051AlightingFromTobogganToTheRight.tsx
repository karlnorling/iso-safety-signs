...
export const M051AlightingFromTobogganToTheRight = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-m051-alighting-from-toboggan-to-the-right`;
  const titleId = `iso-title-m051-alighting-from-toboggan-to-the-right`;
...
M051AlightingFromTobogganToTheRight.displayName = 'M051AlightingFromTobogganToTheRight';
