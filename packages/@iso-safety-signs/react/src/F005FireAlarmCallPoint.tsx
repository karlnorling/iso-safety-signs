...
const _title = "Fire alarm call point";
const _description = "Fire alarm call point";

export const F005FireAlarmCallPoint = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
F005FireAlarmCallPoint.displayName = 'F005FireAlarmCallPoint';
