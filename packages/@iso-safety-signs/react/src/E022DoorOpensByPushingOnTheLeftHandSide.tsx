...
export const E022DoorOpensByPushingOnTheLeftHandSide = React.memo<SignProps>(({
...
E022DoorOpensByPushingOnTheLeftHandSide.displayName = 'E022DoorOpensByPushingOnTheLeftHandSide';
