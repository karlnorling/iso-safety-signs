...
const _title = "Fire alarm flashing light";
const _description = "Fire alarm flashing light";

export const F018FireAlarmFlashingLight = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
F018FireAlarmFlashingLight.displayName = 'F018FireAlarmFlashingLight';
