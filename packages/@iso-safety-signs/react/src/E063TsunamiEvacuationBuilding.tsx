...
const _title = "Tsunami evacuation building";
const _description = "Tsunami evacuation building";

export const E063TsunamiEvacuationBuilding = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
E063TsunamiEvacuationBuilding.displayName = 'E063TsunamiEvacuationBuilding';
