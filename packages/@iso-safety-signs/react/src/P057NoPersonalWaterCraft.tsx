...
export const P057NoPersonalWaterCraft = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p057-no-personal-water-craft`;
  const titleId = `iso-title-p057-no-personal-water-craft`;
...
P057NoPersonalWaterCraft.displayName = 'P057NoPersonalWaterCraft';
