...
export const P003NoOpenFlameFireOpenIgnitionSourceAndSmokingProhibited = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p003-no-open-flame-fire-open-ignition-source-and-smoking-prohibited`;
  const titleId = `iso-title-p003-no-open-flame-fire-open-ignition-source-and-smoking-prohibited`;
...
P003NoOpenFlameFireOpenIgnitionSourceAndSmokingProhibited.displayName = 'P003NoOpenFlameFireOpenIgnitionSourceAndSmokingProhibited';
