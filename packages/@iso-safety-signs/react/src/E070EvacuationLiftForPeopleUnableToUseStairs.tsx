...
const _title = "Evacuation lift for people unable to use stairs";
const _description = "Evacuation lift for people unable to use stairs";

export const E070EvacuationLiftForPeopleUnableToUseStairs = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
E070EvacuationLiftForPeopleUnableToUseStairs.displayName = 'E070EvacuationLiftForPeopleUnableToUseStairs';
