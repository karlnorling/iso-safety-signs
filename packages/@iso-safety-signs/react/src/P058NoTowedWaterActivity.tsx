...
export const P058NoTowedWaterActivity = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p058-no-towed-water-activity`;
  const titleId = `iso-title-p058-no-towed-water-activity`;
...
P058NoTowedWaterActivity.displayName = 'P058NoTowedWaterActivity';
