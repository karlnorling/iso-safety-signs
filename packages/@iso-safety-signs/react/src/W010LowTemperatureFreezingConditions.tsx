...
const _title = "Low temperature/freezing conditions";
const _description = "Low temperature/freezing conditions";

export const W010LowTemperatureFreezingConditions = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
W010LowTemperatureFreezingConditions.displayName = 'W010LowTemperatureFreezingConditions';
