...
export const P014NoAccessForPeopleWithMetallicImplants = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p014-no-access-for-people-with-metallic-implants`;
  const titleId = `iso-title-p014-no-access-for-people-with-metallic-implants`;
...
P014NoAccessForPeopleWithMetallicImplants.displayName = 'P014NoAccessForPeopleWithMetallicImplants';
