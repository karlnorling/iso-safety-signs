...
export const P036NoChildrenAllowed = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p036-no-children-allowed`;
  const titleId = `iso-title-p036-no-children-allowed`;
...
P036NoChildrenAllowed.displayName = 'P036NoChildrenAllowed';
