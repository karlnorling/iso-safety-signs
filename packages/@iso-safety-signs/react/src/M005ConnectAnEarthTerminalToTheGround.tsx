...
export const M005ConnectAnEarthTerminalToTheGround = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
M005ConnectAnEarthTerminalToTheGround.displayName = 'M005ConnectAnEarthTerminalToTheGround';
