...
export const P054NoWindsurfing = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p054-no-windsurfing`;
  const titleId = `iso-title-p054-no-windsurfing`;
...
P054NoWindsurfing.displayName = 'P054NoWindsurfing';
