...
const _title = "Embarkment ladder";
const _description = "Embarkment ladder";

export const E053EmbarkmentLadder = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
E053EmbarkmentLadder.displayName = 'E053EmbarkmentLadder';
