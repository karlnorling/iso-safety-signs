...
export const M052KeepDistanceBetweenToboggans = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-m052-keep-distance-between-toboggans`;
  const titleId = `iso-title-m052-keep-distance-between-toboggans`;
...
M052KeepDistanceBetweenToboggans.displayName = 'M052KeepDistanceBetweenToboggans';
