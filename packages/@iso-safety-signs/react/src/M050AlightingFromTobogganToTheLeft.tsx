...
export const M050AlightingFromTobogganToTheLeft = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-m050-alighting-from-toboggan-to-the-left`;
  const titleId = `iso-title-m050-alighting-from-toboggan-to-the-left`;
...
M050AlightingFromTobogganToTheLeft.displayName = 'M050AlightingFromTobogganToTheLeft';
