...
const _title = "Wear safety belts";
const _description = "Wear safety belts";

export const M020WearSafetyBelts = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
M020WearSafetyBelts.displayName = 'M020WearSafetyBelts';
