...
const _title = "Fixed fire extinguishing bottle";
const _description = "Fixed fire extinguishing bottle";

export const F013FixedFireExtinguishingBottle = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
F013FixedFireExtinguishingBottle.displayName = 'F013FixedFireExtinguishingBottle';
