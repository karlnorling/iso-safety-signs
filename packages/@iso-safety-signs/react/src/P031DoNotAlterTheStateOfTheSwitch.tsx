...
export const P031DoNotAlterTheStateOfTheSwitch = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
P031DoNotAlterTheStateOfTheSwitch.displayName = 'P031DoNotAlterTheStateOfTheSwitch';
