...
export const M044StartAirSupplyInLaunchSequence = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-m044-start-air-supply-in-launch-sequence`;
  const titleId = `iso-title-m044-start-air-supply-in-launch-sequence`;
...
M044StartAirSupplyInLaunchSequence.displayName = 'M044StartAirSupplyInLaunchSequence';
