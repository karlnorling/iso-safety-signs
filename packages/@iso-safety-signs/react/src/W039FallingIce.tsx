...
const _svg: ParsedSvg = {
  attrs: "xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 599.75 523.6\" xml:space=\"preserve\"",
...
const _title = "Falling ice";
const _description = "Falling ice";

export const W039FallingIce = React.memo<SignProps>((props) => (
