...
const _title = "Tsunami evacuation area";
const _description = "Tsunami evacuation area";

export const E062TsunamiEvacuationArea = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
E062TsunamiEvacuationArea.displayName = 'E062TsunamiEvacuationArea';
