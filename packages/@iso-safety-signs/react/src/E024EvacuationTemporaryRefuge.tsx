...
const _title = "Evacuation temporary refuge";
const _description = "Evacuation temporary refuge";

export const E024EvacuationTemporaryRefuge = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
E024EvacuationTemporaryRefuge.displayName = 'E024EvacuationTemporaryRefuge';
