...
const _title = "Fire extinguisher";
const _description = "Fire extinguisher";

export const F001FireExtinguisher = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
F001FireExtinguisher.displayName = 'F001FireExtinguisher';
