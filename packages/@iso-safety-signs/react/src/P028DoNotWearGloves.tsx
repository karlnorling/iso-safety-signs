...
export const P028DoNotWearGloves = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p028-do-not-wear-gloves`;
  const titleId = `iso-title-p028-do-not-wear-gloves`;
...
P028DoNotWearGloves.displayName = 'P028DoNotWearGloves';
