...
const _title = "Emergency position indicating radio beacon";
const _description = "Emergency position indicating radio beacon";

export const E052EmergencyPositionIndicatingRadioBeacon = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
E052EmergencyPositionIndicatingRadioBeacon.displayName = 'E052EmergencyPositionIndicatingRadioBeacon';
