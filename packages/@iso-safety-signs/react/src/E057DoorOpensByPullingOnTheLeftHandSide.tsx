...
export const E057DoorOpensByPullingOnTheLeftHandSide = React.memo<SignProps>(({
...
E057DoorOpensByPullingOnTheLeftHandSide.displayName = 'E057DoorOpensByPullingOnTheLeftHandSide';
