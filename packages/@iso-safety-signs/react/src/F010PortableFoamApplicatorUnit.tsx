...
const _title = "Portable foam applicator unit";
const _description = "Portable foam applicator unit";

export const F010PortableFoamApplicatorUnit = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
F010PortableFoamApplicatorUnit.displayName = 'F010PortableFoamApplicatorUnit';
