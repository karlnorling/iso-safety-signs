...
export const W072SubstanceOrMixtureThatCanCauseAnEnvironmentalHazard = React.memo<SignProps>((props) => (
  <SignSvg {...props} defaultDescription={_description} defaultTitle={_title} svg={_svg} />
));
W072SubstanceOrMixtureThatCanCauseAnEnvironmentalHazard.displayName = 'W072SubstanceOrMixtureThatCanCauseAnEnvironmentalHazard';
