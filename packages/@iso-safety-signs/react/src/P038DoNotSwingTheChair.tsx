...
export const P038DoNotSwingTheChair = React.memo<SignProps>(({
  ...
  const descId = `iso-desc-p038-do-not-swing-the-chair`;
  const titleId = `iso-title-p038-do-not-swing-the-chair`;
...
P038DoNotSwingTheChair.displayName = 'P038DoNotSwingTheChair';
