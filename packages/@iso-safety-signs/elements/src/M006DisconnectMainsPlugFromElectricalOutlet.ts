...
export class M006DisconnectMainsPlugFromElectricalOutlet extends HTMLElement {
  static readonly tagName = 'iso-m006-disconnect-mains-plug-from-electrical-outlet';
