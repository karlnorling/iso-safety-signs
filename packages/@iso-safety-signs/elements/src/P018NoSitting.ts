...
export class P018NoSitting extends HTMLElement {
  ...
  private _render(): void {
    const descId = `iso-desc-p018-no-sitting`;
    const titleId = `iso-title-p018-no-sitting`;
