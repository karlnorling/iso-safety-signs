...
export class P006NoAccessForForkliftTrucksAndIndustrialVehicles extends HTMLElement {
  static readonly tagName = 'iso-p006-no-access-for-forklift-trucks-and-industrial-vehicles';
