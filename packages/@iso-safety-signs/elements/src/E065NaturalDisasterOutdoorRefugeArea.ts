...
const _title = "Natural disaster outdoor refuge area";
const _description = "Natural disaster outdoor refuge area";

export class E065NaturalDisasterOutdoorRefugeArea extends SignElement {
  static readonly tagName = 'iso-e065-natural-disaster-outdoor-refuge-area';
