...
const _title = "Emergency exit for people unable to walk or with walking impairment (left)";
const _description = "Emergency exit for people unable to walk or with walking impairment (left)";

export class E026EmergencyExitForPeopleUnableToWalkOrWithWalkingImpairmentLeft extends SignElement {
  static readonly tagName = 'iso-e026-emergency-exit-for-people-unable-to-walk-or-with-walking-impairment-left';
