...
const _title = "Emergency stop button";
const _description = "Emergency stop button";

export class E020EmergencyStopButton extends SignElement {
  static readonly tagName = 'iso-e020-emergency-stop-button';
