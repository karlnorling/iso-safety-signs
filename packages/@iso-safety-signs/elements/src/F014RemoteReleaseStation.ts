...
const _title = "Remote release station";
const _description = "Remote release station";

export class F014RemoteReleaseStation extends SignElement {
  static readonly tagName = 'iso-f014-remote-release-station';
