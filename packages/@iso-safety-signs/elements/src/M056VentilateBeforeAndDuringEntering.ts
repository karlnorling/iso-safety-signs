...
const _svg: ParsedSvg = {
  attrs: "xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 265 265\" xml:space=\"preserve\" style=\"fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:square;stroke-miterlimit:1\"",
...
const _title = "Ventilate before and during entering";
const _description = "Ventilate before and during entering";

export class M056VentilateBeforeAndDuringEntering extends SignElement {
  static readonly tagName = 'iso-m056-ventilate-before-and-during-entering';
