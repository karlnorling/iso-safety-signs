...
export class P030DoNotTieKnotsInRope extends HTMLElement {
  ...
  private _render(): void {
    const descId = `iso-desc-p030-do-not-tie-knots-in-rope`;
    const titleId = `iso-title-p030-do-not-tie-knots-in-rope`;
