...
export class P003NoOpenFlameFireOpenIgnitionSourceAndSmokingProhibited extends HTMLElement {
  static readonly tagName = 'iso-p003-no-open-flame-fire-open-ignition-source-and-smoking-prohibited';
