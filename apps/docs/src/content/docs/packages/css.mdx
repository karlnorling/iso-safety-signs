...
| Class       | Sign                  | Category    |
|-------------|-----------------------|-------------|
| `iso-e001`  | Emergency exit (left) | Emergency   |
| `iso-p002`  | No smoking            | Prohibition |
| `iso-m004`  | Wear eye protection   | Mandatory   |
| `iso-w021`  | Flammable material    | Warning     |
...
<body>
  ...
  <span class="sign iso-w021" role="img" aria-label="Flammable material"></span>
</body>
</html>
```
